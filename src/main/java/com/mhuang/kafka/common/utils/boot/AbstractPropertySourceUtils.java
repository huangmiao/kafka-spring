package com.mhuang.kafka.common.utils.boot;
 ...
 * @see PropertySources
 */
public abstract class AbstractPropertySourceUtils {
	 ...
	 * @see AbstractPropertySourceUtils#getSubProperties(PropertySources, String, String)
	 */
	public static Map<String, Object> getSubProperties(PropertySources propertySources,
			String keyPrefix) {
		return AbstractPropertySourceUtils.getSubProperties(propertySources, null, keyPrefix);
	}
		...
		for (PropertySource<?> source : propertySources) {
			if (source instanceof EnumerablePropertySource) {
				for (String name : ((EnumerablePropertySource<?>) source)
						.getPropertyNames()) {
					String key = AbstractPropertySourceUtils.getSubKey(name, rootPrefix,
							keyPrefixes);
